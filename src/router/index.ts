...
const routes: RouteRecordRaw[] = [
  ...
  { path: '/world/landmarks', name: 'world-landmarks', component: () => import('@/views/WorldView.vue') },
  { path: '/world/factions', name: 'world-factions', component: () => import('@/views/FactionsView.vue') },
  { path: '/world/npcs', name: 'world-npcs', component: () => import('@/views/NPCsView.vue') },
